...
**Location:** `/Users/callum/datix/INTEGRATION.md`
...
**Location:** `/Users/callum/datix-website-rebuild/nextjs-app/src/app/docs/integrate/page.tsx`
...
**URL (after deploy):** `datixprotocol.com/docs/integrate`

---

### 3. Public Markdown Copy
**Location:** `/Users/callum/datix-website-rebuild/nextjs-app/public/INTEGRATION.md`

**Purpose:** Direct link for platforms that want raw markdown

**URL (after deploy):** `datixprotocol.com/INTEGRATION.md`

---

### 4. Launch Tweet Thread
**Location:** `/Users/callum/datix/INTEGRATION-LAUNCH-TWEET.md`
...
```bash
cd /Users/callum/datix-website-rebuild
...
**Copy from:** `/Users/callum/datix/INTEGRATION-LAUNCH-TWEET.md`
...
"Week 2 progress: Shipped integration docs with real code examples. Platforms can now add datix verification in 10 minutes. Removed friction from integration → makes closing 5 platform deals feasible by late March."

**Links to include:**
- Docs page: `datixprotocol.com/docs/integrate`
- GitHub SDK: `github.com/kaiclawd/datix-sdk`
...
**Before:** Platforms interested in datix had to figure out integration themselves.
