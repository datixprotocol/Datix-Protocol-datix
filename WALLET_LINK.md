# Wallet Link: Multi-Wallet Identity for datix Protocol
...
# - target/deploy/datix.so        (program binary)
# - target/idl/datix.json          (IDL)
# - target/types/datix.ts          (TypeScript types)
```
